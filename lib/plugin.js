        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tsconfigFiles = [];
                    typingsFiles = [];
                    return [4, loadConfig(sjsconfig, _resolve, _fetchJson)];
                case 1:
                    config = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, _fetchJson(tsconfigAddress)];
                case 2:
                    tsconfigObj = _a.sent();
                    result = typescript_1.parseConfigFileTextToJson(tsconfigAddress, JSON.stringify(tsconfigObj));
                    if (result.error) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    deps = _b.sent();
                    return [4, Promise.all(deps.list
                            .filter(function (d) { return isTypescript(d); })
                            .filter(function (d) { return !host.fileExists(d); })
                            .map(function (d) { return isTypescriptDeclaration(d) ? d + '!' + __moduleName : d; })
                            .map(function (d) { return System["import"](d, load.address); }))];
                case 3:
                    _b.sent();
...
function instantiate(load, origInstantiate) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (isJson(load.address)) {
                return [2, JSON.parse(load.source)];
            }
            else if (loader.build && isTypescript(load.address)) {
                return [2, loader._loader.modules['@empty']];
            }
            else if (isTypescriptDeclaration(load.address)) {
                return [2, loader.registry.get('@empty')];
            }
            else {
                return [2, origInstantiate(load)];
            }
            return [2];
        });
    });
...
function _fetchJson(address) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, SystemJS["import"](address + '!' + __moduleName)];
                case 1:
                    json = _a.sent();
